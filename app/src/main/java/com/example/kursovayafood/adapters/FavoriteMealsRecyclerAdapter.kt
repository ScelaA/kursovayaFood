package com.example.kursovayafood.adapters
...
import com.example.kursovayafood.databinding.FavMealCardBinding
...
class FavoriteMealsRecyclerAdapter :
    ...
    override fun onBindViewHolder(holder: FavoriteViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            /*tvFavMealCountry.text = favoriteMeals[position].mealCountry*/
